...
void addEvents() {
  // Brightening
  addEvent(4, 00, 3 * SECS_PER_HOUR);
  addEvent(17, 00, 3 * SECS_PER_HOUR);

  // Analemma
  addEvent(9, 51, 2 * SECS_PER_MIN);
  addEvent(10, 23, 2 * SECS_PER_MIN);
  addEvent(10, 55, 2 * SECS_PER_MIN);
  addEvent(11, 27, 2 * SECS_PER_MIN);

  addEvent(11, 59, 2 * SECS_PER_MIN);

  addEvent(12, 31, 2 * SECS_PER_MIN);
  addEvent(13, 3, 2 * SECS_PER_MIN);
  addEvent(13, 35, 2 * SECS_PER_MIN);
  addEvent(14, 7, 2 * SECS_PER_MIN);
}
